...
#android.permissions = android.permission.INTERNET,android.permission.ACCESS_FINE_LOCATION,android.permission.ACCESS_COARSE_LOCATION, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
